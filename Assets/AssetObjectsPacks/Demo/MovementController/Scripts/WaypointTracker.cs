...
public class WaypointTracker : MovementControllerComponent
{
    ...
    public void GoTo (Vector3 newDestination, Action onWaypointArrive = null) {
        Playlist.InitializePerformance("nav ai manual", behavior.wayPointCue, eventPlayer, false, eventLayer, newDestination, Quaternion.identity, false, onWaypointArrive);
    }
    ...
    */
    void GoToWaypoint(object[] parameters) {
        ...
        //DebugTransform.instance.transform.position = newDestination;
        //Debug.Break();
